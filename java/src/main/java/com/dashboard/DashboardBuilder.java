...
/**
 * DashboardBuilder -- entry point called by sparkta.ado via javacall.
 *
...
public class DashboardBuilder {
    ...
    private static int checkOfflinePreflight(DashboardOptions o) {
        ...
        required.add("/com/dashboard/js/chartjs-4.4.0.min.js");
        required.add("/com/dashboard/js/chartjs-datalabels-2.2.0.min.js");
        required.add("/com/dashboard/js/chartjs-errorbars-4.4.0.min.js");
        required.add("/com/dashboard/js/chartjs-boxplot-4.4.5.min.js");
        required.add("/com/dashboard/js/canvas2svg-1.0.19.js");
        if (o.hasAnnotations()) {
            required.add("/com/dashboard/js/chartjs-annotation-3.0.1.min.js");
        }
